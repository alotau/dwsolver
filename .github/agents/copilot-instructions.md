...
- C11 (GNU Autotools build, GCC/Clang) + GLPK ≥ 4.65 (runtime); GNU Autotools (build); GitHub Actions (CI) (015-openssf-passing-badge)
- N/A (no database; flat-file build outputs) (015-openssf-passing-badge)
...
## Recent Changes
- 015-openssf-passing-badge: Added C11 (GNU Autotools build, GCC/Clang) + GLPK ≥ 4.65 (runtime); GNU Autotools (build); GitHub Actions (CI)
