...
int phase_1_iteration(subprob_struct* sub_data, faux_globals*, int first_run,
		char** obj_names, double* obj_coefs, int* obj_count, master_data*);

int phase_2_iteration(subprob_struct* sub_data, faux_globals*, master_data*) ;
